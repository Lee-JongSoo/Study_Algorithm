 ...
 *
 * 입력
 * 첫 줄에 자연수 N(5<=N<=30)이 주어집니다. 번째 줄부터 N*N board 배열이 주어집니다.
 * board의 각 칸에는 0 이상 100 이하인 정수가 담겨있습니다. 0은 빈 칸을 나타냅니다.
 * 1 ~ 100의 각 숫자는 각기 다른 인형의 모양을 의미하며 같은 숫자는 같은 모양의 인형을 나타냅니다.
 * board배열이 끝난 다음줄에 moves 배열의 길이 M이 주어집니다.마지막 줄에는 moves 배열이 주어집니다.
...
public class PuppetDraw {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(puppetDraw.solution(board, moves));
    }
}
